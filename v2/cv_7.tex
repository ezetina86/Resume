...
\item Getting predictions \& explanations of AutoML and Custom Models deployed.
...
\item Preparing POCs, demos, and presentations for the Equifax stakeholders.
\end{itemize}}

\cventry{April 2019--September 2022}{Senior Systems Engineer}{\textsc{EPAM Systems, Inc}}{Google Cloud Platform Support}{}{
\begin{itemize}
\item Providing technical support for Google customers, using GCP products, including Big Data technologies, and related services.
\item Identifying and documenting product bugs and feature requests, working with internal support teams and customers to implement efficient solutions to their business.
\item I worked closely with internal support teams to improve cloud products at senior level.
\item I helped Google's customers to automate Cloud deployments by using Terraform.
\item Helping customers to develop solutions using Big Data tools like Apache Beam (Cloud Dataflow),  Apache Airflow (Cloud Composer) and Hadoop \& Spark jobs (Cloud Dataproc).
\item I obtained a certification as a technical interviewer inside the company (EPAM).
\item I created webinars at a global scale to help EPAMers obtain the Google Cloud Data Engineer certification.
\item I participated as a Big Data committee expert, and Cloud Computing committee expert, evaluating EPAMers in their assessment processes to get promotions inside the company.
\item I was a mentor in the \textit{Resource Development} program, helping new hires to get experience in Google Cloud and Big data Technologies.
\end{itemize}}
...
\href{https://www.credential.net/b34659fc-1fc6-44e6-9c10-5ece60735b1d}{Cloud Digital Leader}
}
