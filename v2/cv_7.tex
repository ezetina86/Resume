...
\homepage{https://www.ezetina.com}{ezetina.com}
...
\cventry{March 2022--September 2022}{Lead Systems Engineer}{\textsc{EPAM Systems, Inc}}{Equifax Key developer}{}{
\begin{itemize}
\item Creating ML models using Vertex AI.
\item Designing architectural solutions for GCP Vertex AI environments.
\item Creating ML AutoML and Custom models using Vertex AI.
\item Deploying models created to standard and private endpoints.
\item Working on creating and maintaining Feature Stores.
\item Creating Model Monitoring jobs to check the performance of ML Models.
\item Getting predictions & explanations of AutoML and Custom Model deployed.
...
\item Developing terraform modules to deploy vertex infrastructure in the cloud.
\item Preparing POCs, demos, and presentations for the Equifax management team.
\end{itemize}}

\cventry{April 2019--September 2022}{Senior Systems Engineer}{\textsc{EPAM Systems, Inc}}{Google Cloud Platform Support}{}{
\begin{itemize}
...
%\title{Curriculum Vitae}
%\address{Callejón Central 8, Santa Catarina Azcapotzalco}{CDMX, México​}
\mobile{(+52) 56 2774 5677}
%\phone{(000) 111 1112}
%\fax{(000) 111 1113}
\email{jenzetin@gmail.com}
\homepage{https://www.ezetina.com}{ezetina.com} % The first argument is the url for the clickable link, the secofond argument is the url displayed in the template - this allows special characters to be displayed such as the tilde in this example
...
\cvitem{Big Data}{Apache Airflow, Apache Beam}
...
\cvitem{Google Cloud}{
\href{https://www.credential.net/675b715d-d013-479c-a3e9-5caf78ef987a}{Associate Cloud Engineer},
\href{https://www.credential.net/7c6ceb85-96cc-48b1-a0f0-ccd438603d2c}{Professional Data Engineer}
\href{https://www.credential.net/acba7c66-8710-4e43-859b-b2ef017e8c4a}{Professional Cloud Architect} 
}
